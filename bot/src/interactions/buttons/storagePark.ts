...
export async function handleStoragePark(interaction: ButtonInteraction): Promise<void> {
	...
	try {
		...
		await interaction.editReply({
			embeds: [buildStorageResultEmbed(result.ok ? "🅿️ Dino Parked" : "Park Failed", result.ok, result.msg)],
		});
	} catch (e) {
